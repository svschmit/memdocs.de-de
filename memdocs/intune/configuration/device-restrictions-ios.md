...
- **Beobachtung von Remotebildschirmen durch Classroom-App**: **Blockieren** verhindert, dass die Classroom-App den Bildschirm des Geräts remote anzeigt. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem der Classroom-App von Apple erlauben, den Bildschirm anzuzeigen.
...
- **Bildschirmzeit**: **Blockieren** verhindert, dass Benutzer ihre eigenen Einschränkungen in „Bildschirmzeit“ (Geräteeinstellungen) vornehmen. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Benutzern das Konfigurieren von Geräteeinschränkungen (z. B. Jugendschutz oder Inhalts- und Datenschutzeinschränkungen) auf dem Gerät erlauben.
...
- **Entfernen von Apps blockieren**: **Blockieren** hindert Benutzer daran, Apps zu entfernen. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Benutzern erlauben, Apps vom Gerät zu entfernen.
- **USB-Zubehör bei gesperrtem Gerät zulassen**: **Zulassen**: USB-Zubehör kann Daten mit einem Gerät austauschen, das seit mehr als einer Stunde gesperrt ist. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem den Modus mit USB-Einschränkung auf dem Gerät nicht aktualisieren, und USB-Zubehör wird daran gehindert, Daten vom Gerät zu übertragen, wenn dieses länger als eine Stunde gesperrt ist.
...
- **VPN-Erstellung blockieren**: **Blockieren** hindert Benutzer daran, VPN-Konfigurationseinstellungen zu erstellen. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Benutzern das Erstellen von VPNs auf dem Gerät erlauben.
- **eSIM-Einstellungen ändern**: **Blockieren** hindert Benutzer am Entfernen oder Hinzufügen eines Mobilfunktarifplans zum eSIM auf dem Gerät. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Benutzern erlauben, diese Einstellungen zu ändern.

  Diese Funktion gilt für:  
  - iOS 12.1 und neuer
  - iOS 13.0 und höher

- **Softwareupdates zurückstellen**: Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Softwareupdates auf dem Gerät anzeigen, wenn Apple sie veröffentlicht. Wenn beispielsweise ein iOS/iPadOS-Update von Apple an einem bestimmten Datum veröffentlicht wird, wird dieses Update normalerweise am Veröffentlichungsdatum auf dem Gerät angezeigt.
...
- **Kennwort:** **Anfordern** der Kennworteingabe durch den Benutzer für den Zugriff auf das Gerät. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Benutzern erlauben, ohne Kennworteingabe auf das Gerät zuzugreifen.
...
- **Touch ID und Face ID entsperren:** **Blockieren** verhindert die Verwendung eines Fingerabdrucks oder Gesichts zum Entsperren des Geräts. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Benutzern das Entsperren des Geräts mithilfe dieser Methoden erlauben.
...
- **Kennwortanforderungen durch Näherung blockieren**: Wählen Sie **Blockieren** aus, damit das Gerät eines Benutzers keine Kennwörter von in der Nähe befindlichen Geräten anfordert. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem diese Kennwortanforderungen zulassen.
...
- **App Store:** **Blockieren** verhindert, dass auf überwachten Geräten auf den App Store zugegriffen werden kann. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem den Zugriff erlauben.
  ...
  - **Installieren von Apps über den App Store**: Wählen Sie **Blockieren** aus, um den App Store auf dem Startbildschirm des Geräts zu blockieren. Benutzer können weiterhin iTunes oder das Apple Configurator-Tool zum Installieren von Apps verwenden. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem den App Store auf dem Startbildschirm zulassen.
...
- **Game Center**: **Blockieren** verhindert, dass die Game Center-App verwendet werden kann. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem die Verwendung der Game Center-App auf dem Gerät zulassen.
- **Multiplayerspiele:** **Blockieren** verhindert Multiplayerspiele. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Benutzern erlauben, Multiplayerspiele auf dem Gerät zu spielen.
...
- **Siri:** **Blockieren** verhindert den Zugriff auf Siri. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem die Verwendung des Sprach-Assistenten Siri auf dem Gerät zulassen.
  - **Siri bei Gerätesperre:** **Blockieren** verhindert den Zugriff auf Siri, wenn das Gerät gesperrt ist. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem die Verwendung des Sprach-Assistenten Siri auf dem Gerät zulassen, wenn das Gerät gesperrt ist.

- **Safari-Betrugswarnungen**: **Anfordern**, dass Betrugswarnungen im Webbrowser auf dem Gerät angezeigt werden. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem diese Funktion deaktivieren.
...
- **Safari-JavaScript**: **Blockieren** verhindert, dass auf dem Gerät Java-Skripts im Browser ausgeführt werden. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Java-Skripts zulassen.
...
- **Kamera:** **Blockieren** verhindert den Zugriff auf die Kamera des Geräts. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem den Zugriff auf die Kamera des Geräts zulassen.
  ...
  - **FaceTime:** Mit **Blockieren** verhindern Sie den Zugriff auf die FaceTime-App. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem den Zugriff auf die FaceTime-App auf dem Gerät zulassen.
...
- **Apple News**: **Blockieren** verhindert auf dem Gerät den Zugriff auf die Apple News-App. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem die Verwendung der Apple News-App zulassen.
...
- **iTunes Radio-Dienst**: **Blockieren** verhindert, dass Benutzer die iTunes Radio-App verwenden können. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem die Verwendung der iTunes Radio-App zulassen.
- **iTunes Store:** Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem iTunes auf den Geräten zulassen. Wenn **Blockieren** festgelegt wird, können Benutzer iTunes nicht auf dem Gerät verwenden.

  Diese Funktion gilt für:  
  - iOS 4.0 und neuer
  - iOS 13.0 und höher

- **Mein iPhone suchen:** Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem die Verwendung des Such-App-Features zum Abrufen des ungefähren Standorts des Geräts zulassen. Die Einstellung **Blockieren** verhindert die Verwendung dieses Features der App. 

  Diese Funktion gilt für:  
  - iOS 13.0 und neuer
  - iOS 13.0 und höher

- **Meine Freunde suchen:** Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem die Verwendung des Such-App-Features zum Suchen von Familienmitgliedern und Freunden über ein Apple-Gerät oder iCloud.com zulassen. Die Einstellung **Blockieren** verhindert die Verwendung dieses Features der App.
...
- **Entfernen von System-Apps vom Gerät blockieren**: **Blockieren** deaktiviert die Möglichkeit, System-Apps auf dem Gerät zu entfernen. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Benutzern erlauben, System-Apps vom Gerät zu entfernen.

- **Safari**: **Blockieren** der Verwendung des Safari-Browsers auf dem Gerät. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Benutzern erlauben, den Safari-Browser zu verwenden.

  Ab iOS/iPadOS 13.0 muss es sich bei Geräten mit dieser Einstellung um überwachte Geräte handeln.

- **AutoAusfüllen in Safari**: **Blockieren** deaktiviert auf dem Gerät das AutoAusfüllen-Feature in Safari. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Benutzern erlauben, Einstellungen für AutoVervollständigen im Webbrowser zu ändern.
...
- **Liste der eingeschränkten App-Typen:** Mit dieser Einstellung wird eine Liste der Apps erstellt, die Benutzer nicht installieren oder verwenden dürfen. Folgende Optionen sind verfügbar:
  ...
  - **Nicht konfiguriert** (Standardeinstellung): Diese Einstellung wird von Intune nicht geändert oder aktualisiert. Benutzer können auf integrierte Apps und Apps zugreifen, die Sie ihnen zuweisen.
...
- **Sprachwahlverfahren:** **Blockieren** hindert Benutzer daran, das Sprachwahlverfahren auf dem Gerät zu verwenden. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem das Sprachwahlverfahren auf dem Gerät zulassen.
- **Sprachroaming:** **Blockieren** verhindert das Sprachroaming über das Mobilfunknetzwerk. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Sprachroaming zulassen, wenn das Gerät in einem Mobilfunknetz verwendet wird.
...
- **WLANs nur unter Verwendung von Konfigurationsprofilen beitreten**: **Anfordern** zwingt das Gerät, nur WLAN-Netzwerke zu verwenden, die mithilfe von Intune-Konfigurationsprofilen eingerichtet wurden. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem dem Gerät erlauben, andere WLAN-Netzwerke zu verwenden.
...
- **Kopplungskennwort für ausgehende AirPlay-Anforderungen anfordern:** **Anfordern** benötigt ein Kopplungskennwort, wenn Benutzer AirPlay zum Streamen von Inhalten auf andere Apple-Geräte verwenden. **Nicht konfiguriert** (Standard) ermöglicht Benutzern das Streamen von Inhalten über AirPlay ohne Kennworteingabe.

### <a name="settings-apply-to-automated-device-enrollment-supervised"></a>Die Einstellungen gelten für: Automatisierte Geräteregistrierung (überwacht)

- **AirDrop**: **Blockieren** verhindert die Verwendung von AirDrop auf dem Gerät. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem die Verwendung von AirDrop zum Austauschen von Inhalten mit Geräten in der Nähe zulassen.
...
- **Bluetooth-Änderung**: **Blockieren** hindert Benutzer daran, die Bluetootheinstellungen auf dem Gerät zu ändern. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Benutzern erlauben, diese Einstellungen zu ändern.
- **Hostkopplung zum Steuern der Geräte, mit denen ein iOS/iPadOS-Gerät gekoppelt werden kann**: Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem die Hostkopplung zulassen, damit der Administrator steuern kann, mit welchen Geräten ein iOS/iPadOS-Gerät gekoppelt werden darf. **Blockieren** verhindert die Hostkopplung.
- **AirPrint blockieren**: **Blockieren** verhindert die Verwendung des AirPrint-Features auf dem Gerät. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Benutzern erlauben, AirPrint zu verwenden.
  - **Speicherung von AirPrint-Anmeldeinformationen im Schlüsselbund blockieren**: **Blockieren** verhindert, dass Benutzername und Kennwort auf dem Gerät im Keychain-Speicher gespeichert werden. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem das Speichern von AirPrint-Benutzername und -Kennwort in der Keychain-App zulassen.
...
- **Suche nach Wortdefinition**: **Blockieren** hindert Benutzer daran, ein Wort zu markieren und dann auf dem Gerät nach seiner Definition zu suchen. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem den Zugriff auf die Definitionssuchfunktion zulassen.
- **Tastaturwortvorschläge**: Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem die Verwendung von Tastaturwortvorschlägen für Wörter zulassen, die der Benutzer möglicherweise verwenden möchte. **Blockieren** verhindert die Verwendung dieser Funktion.
- **Autokorrektur**: Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem dem Gerät die automatische Korrektur falsch geschriebener Wörter gestatten. **Blockieren** verhindert die Verwendung von Autokorrektur.
- **Rechtschreibprüfung über Tastatur:** Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem die Verwendung der Rechtschreibprüfung auf dem Gerät zulassen. **Blockieren** ermöglicht die Rechtschreibprüfung.
- **Tastenkombinationen:** Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem die Verwendung von Tastenkombinationen auf dem Gerät zulassen. **Blockieren** hindert Benutzer an der Verwendung von Tastenkombinationen.
...
- **Synchronisierung verwalteter Apps mit der Cloud:** Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem zulassen, dass Ihre mit Intune verwalteten Apps Daten mit dem iCloud-Konto des Benutzers synchronisieren. **Blockieren** verhindert diese Datensynchronisierung mit iCloud.
- **Enterprise Book-Sicherung blockieren:** **Blockieren** verhindert, dass Benutzer Enterprise Books sichern. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Benutzern erlauben, diese Bücher zu sichern.
...
- **Synchronisierung von Fotostreams in iCloud:** Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Benutzern das Aktivieren von **Mein Fotostream** auf ihren Geräten zum Synchronisieren mit iCloud erlauben, damit Fotos auf allen Geräten der Benutzer verfügbar sind. **Blockieren** verhindert die Fotostream-Synchronisierung mit iCloud. Wenn dieses Feature blockiert wird, kann es zu Datenverlust kommen. 
- **iCloud-Fotomediathek:** **Blockieren** deaktiviert die Verwendung der iCloud-Fotomediathek zum Speichern von Fotos und Videos in der Cloud. Fotos, die nicht vollständig aus der iCloud-Fotomediathek auf das Gerät heruntergeladen wurden, werden vom Gerät entfernt. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem die Verwendung der iCloud-Fotomediathek zulassen.
- **Streaming freigegebener Fotos:** **Blockieren** deaktiviert die **iCloud-Fotofreigabe** auf dem Gerät. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem das Streamen freigegebener Fotos zulassen.
- **Handoff:** Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Benutzern erlauben, mit der Arbeit auf einem iOS/iPadOS-Gerät zu beginnen und sie auf einem anderen iOS/iPadOS- oder macOS-Gerät fortzusetzen. **Blockieren** verhindert diese Übergabe.

### <a name="settings-apply-to-automated-device-enrollment-supervised"></a>Die Einstellungen gelten für: Automatisierte Geräteregistrierung (überwacht)

- **In iCloud sichern:** Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Benutzern erlauben, das Gerät in iCloud zu sichern. **Blockieren** hindert Benutzer daran, das Gerät in iCloud zu sichern.

  Ab iOS/iPadOS 13.0 muss es sich bei Geräten mit dieser Einstellung um überwachte Geräte handeln.

- **iCloud-Dokumentsynchronisierung blockieren**: Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem die Dokument- und Schlüssel-/Wertsynchronisierung in Ihrem iCloud-Speicher zulassen. **Blockieren** hindert iCloud daran, Dokumente und Daten zu synchronisieren.
...
- **Mono-Audio:** **Anfordern** der Barrierefreiheitseinstellung „Mono-Audio“ auf dem Gerät. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Es besteht die Möglichkeit, dass das Betriebssystem dieses Feature im Kioskmodus standardmäßig nicht ausführt oder aktiviert.
- **Sprachsteuerung**: Bei der Einstellung **Erforderlich** wird die Sprachsteuerung auf dem Gerät aktiviert. Dies ermöglicht Benutzern die vollständige Steuerung des Betriebssystems mithilfe von Siri-Befehlen. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem die Sprachsteuerung auf dem Gerät deaktivieren.
...
- **Standbytaste:** **Blockieren** deaktiviert die Taste für Standby/Aktivierung des Bildschirms am Gerät. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Es besteht die Möglichkeit, dass das Betriebssystem dieses Feature standardmäßig nicht zulässt.
- **Touch:** **Blockieren** deaktiviert den Touchscreen des Geräts. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem Benutzern erlauben, den Touchscreen zu verwenden.
- **Lautstärkeregler:** Bei der Einstellung **Blockieren** werden die Lautstärkeregler des Geräts deaktiviert. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem die Lautstärkeregler zulassen.
...
- **Ausgewählten Text sprechen:** **Zulassen** der Barrierefreiheitseinstellungen „Auswahl vorlesen“ auf dem Gerät. Diese Funktion liest von Benutzern ausgewählte Texte vor. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Standardmäßig könnte das Betriebssystem diese Funktion deaktivieren.
