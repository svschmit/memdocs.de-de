...
Sie können E-Mail-Profile auch für Geräte erstellen, die unter [Android Samsung Knox](email-settings-android.md), [iOS/iPadOS](email-settings-ios.md) und [Windows 10 und höher](email-settings-windows-10.md) ausgeführt werden.
