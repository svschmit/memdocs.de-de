...
[Erstellen Sie ein Konfigurationsprofil für Windows 8.1-Geräteeinschränkungen](device-restrictions-configure.md#create-the-profile).
...
- **Bildcode und PIN:** Mit einem Bildkennwort kann sich der Benutzer mit Gesten auf einem Bild anmelden. Mit einer PIN kann sich der Benutzer mit einem vierstelligen Code schnell anmelden.

  Die Einstellung **Blockieren** verhindert die Verwendung eines Bilds oder einer PIN als Kennwort. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert.
...
- **Verschlüsselung:** Mit der Einstellung **Anfordern** wird Verschlüsselung auf Geräten vorgeschrieben, einschließlich Dateien. Nicht alle Geräte unterstützen die Verschlüsselung. Wenn die Einstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung von Intune nicht geändert oder aktualisiert.
  ...
  - **Minimale Kennwortlänge:** Legen Sie mindestens `6` fest.
...
- **JavaScript zulassen**: Die Einstellung **Blockieren** verhindert die Ausführung von Skripts wie z. B. JavaScript im Browser. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert. Das Betriebssystem könnte JavaScript standardmäßig zulassen.
...
- **Menüzugriff im Unternehmensmodus:** Die Einstellung **Blockieren** hindert Benutzer daran, in Internet Explorer auf die Menüoptionen für den Unternehmensmodus zuzugreifen. Wenn die Standardeinstellung **Nicht konfiguriert** festgelegt ist, wird diese Einstellung nicht von Intune geändert oder aktualisiert.

  Wenn **Nicht konfiguriert** festgelegt ist, geben Sie auf Folgendes ein:
