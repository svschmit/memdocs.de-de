...
- [I got an error while enrolling a macOS virtual machine (Mir wird bei der Registrierung eines virtuellen macOS-Computers ein Fehler angezeigt)](unable-to-get-macOS-device-managed.md)  
- [I got a message that my macOS device serial number is restricted (Ich habe die Benachrichtigung erhalten, dass die Seriennummer meines macOS-Geräts einer Einschränkung unterliegt)](unable-to-get-macOS-device-managed.md)  
- [My device might already be assigned to someone else (Mein Gerät wurde möglicherweise bereits einem anderen Benutzer zugewiesen)](unable-to-get-macOS-device-managed.md)  
