---
title: Standardklassen des Ressourcen-Explorers für die Inventur
titleSuffix: Configuration Manager
description: In diesem Artikel werden die im Ressourcen-Explorer verfügbaren Klassen aufgeführt.
ms.date: 11/12/2019
...
ms.locfileid: "81690178"
---
# <a name="resource-explorer-default-inventory-classes"></a>Standardklassen des Ressourcen-Explorers für die Inventur

*Gilt für: Configuration Manager (Current Branch)*

In diesem Artikel werden die im Ressourcen-Explorer verfügbaren Klassen für die Inventur beschrieben.

Die folgenden Standardklassen stehen für die Inventur zur Verfügung:

## <a name="1394-controller"></a>1394 Controller

Namespace: root\cimv2

Win32_1394Controller-Klasse
...
## <a name="activesync-service"></a>ActiveSync-Dienst

Namespace: root\SmsDm

SMS_ActiveSyncService-Klasse
...
## <a name="appv-client-application"></a>AppV-Clientanwendung

Namespace: root\AppV

AppvClientApplication-Klasse
...
## <a name="appv-client-package"></a>AppV-Clientpaket

Namespace: root\AppV

AppvClientPackage-Klasse
...
## <a name="bitlocker-encryption-details"></a>BitLocker-Verschlüsselungsdetails

Namespace: root\cimv2

Win32_BitLockerEncryptionDetails-Klasse
...
## <a name="bitlocker-policy"></a>BitLocker-Richtlinie

Namespace: root\cimv2

Win32Reg_MBAMPolicy-Klasse
...
## <a name="browser-helper-object"></a>Browserhilfsobjekt

Namespace: root\cimv2\sms

SMS_BrowserHelperObject-Klasse
...
## <a name="computer-system"></a>Computersystem
...
## <a name="computer-system-ex"></a>Computersystem (Erweitert)

Namespace: root\cimv2

CCM_ComputerSystemExtended-Klasse
...
## <a name="computer-system-product"></a>Computersystemprodukt

Namespace: root\cimv2

Win32_ComputerSystemProduct-Klasse
...
## <a name="sms-advanced-client-ports"></a>Ports des erweiterten SMS-Clients

Namespace: root\cimv2

Win32Reg_SMSAdvancedClientPorts-Klasse
...
## <a name="sms-advanced-client-ssl-configurations"></a>SSL-Konfiguration des erweiterten SMS-Clients

Namespace: root\cimv2

Win32Reg_SMSAdvancedClientSSLConfiguration-Klasse
...
## <a name="sms-advanced-client-state"></a>Status des erweiterten SMS-Clients

Namespace: root\ccm

CCM_InstalledComponent-Klasse
...
## <a name="connected-device"></a>Verbundenes Gerät

Namespace: root\SmsDm

SMS_ActiveSyncConnectedDevice-Klasse
...
## <a name="desktop-monitor"></a>Desktopmonitor

Namespace: root\cimv2

Win32_DesktopMonitor-Klasse
...
## <a name="device-info"></a>Geräteinformationen
...
## <a name="mdm-devdetail"></a>Mobile Geräteverwaltung: DevDetail
...
## <a name="dma"></a>Gerätespeicheradresse

Namespace: root\cimv2

Win32_DeviceMemoryAddress-Klasse
...
## <a name="driver---vxd"></a>VxD-Treiber

Namespace: root\cimv2

Win32_DriverVXD-Klasse
...
## <a name="embedded-device-information"></a>Eingebettete Geräteinformationen

Namespace: root\cimv2\sms

CCM_EmbeddedDeviceInformation-Klasse
...
## <a name="usm-folder-redirection-health"></a>Integrität der USM-Ordnerumleitung

Namespace: root\cimv2\sms

SMS_FolderRedirectionHealth-Klasse
...
## <a name="add-remove-programs-64"></a>Software (64-Bit)

Namespace: root\cimv2

Win32Reg_AddRemovePrograms64-Klasse
...
## <a name="add-remove-programs"></a>Software

Namespace: root\cimv2

Win32Reg_AddRemovePrograms-Klasse
...
## <a name="installed-executable"></a>Installierte ausführbare Dateien

Namespace: root\cimv2\sms

SMS_InstalledExecutable-Klasse
...
## <a name="irq-table"></a>IRQ-Tabelle
...
## <a name="load-order-group"></a>Gruppe für Ladereihenfolge

Namespace: root\cimv2

Win32_LoadOrderGroup-Klasse
...
## <a name="logical-disk"></a>Logischer Datenträger

Namespace: root\cimv2\sms

SMS_LogicalDisk-Klasse
...
CCM_LogicalMemoryConfiguration-Klasse
...
## <a name="device-bluetooth"></a>Bluetooth des Geräts

Namespace: Reserviert

Device_Bluetooth-Klasse
...
## <a name="device-camera"></a>Gerätekamera

Namespace: Reserviert

Device_Camera-Klasse
...
## <a name="device-certificates"></a>Gerätezertifikate

Namespace: Reserviert

Device_Certificates-Klasse
...
## <a name="device-client-agent-version"></a>Version des Geräteclient-Agents

Namespace: Reserviert

Device_ClientAgentVersion-Klasse
...
## <a name="device-computer-system"></a>Gerätecomputersystem

Namespace: Reserviert

Device_ComputerSystem-Klasse
...
## <a name="device-display"></a>Gerätebildschirm

Namespace: Reserviert

Device_Display-Klasse
...
## <a name="device-email"></a>Geräte-E-Mail
...
## <a name="device-encryption"></a>Geräteverschlüsselung

Namespace: Reserviert

Device_Encryption-Klasse
...
## <a name="device-exchange"></a>Geräte-Exchange

Namespace: Reserviert

Device_Exchange-Klasse
...
## <a name="device-installed-applications"></a>Auf dem Gerät installierte Anwendungen

Namespace: Reserviert

Device_InstalledApplications-Klasse
...
## <a name="device-irda"></a>Geräte-IrDA
...
## <a name="mobile-device-location"></a>Mobilgerätestandort
...
## <a name="device-memory"></a>Gerätespeicher

Namespace: Reserviert

Device_Memory-Klasse
...
## <a name="device-os-information"></a>Gerätebetriebssysteminformationen

Namespace: Reserviert

Device_OSInformation-Klasse
...
## <a name="device-policy"></a>Geräterichtlinie

Namespace: Reserviert

Device_Policy-Klasse
...
## <a name="device-power"></a>Geräteenergie
...
## <a name="mobile-device-security-status"></a>Sicherheitsstatus des Mobilgeräts

Namespace: Reserviert

MDM_SecurityStatus-Klasse
...
## <a name="device-windows-security-policy"></a>Windows-Sicherheitsgeräterichtlinie

Namespace: Reserviert

Device_WindowsSecurityPolicy-Klasse
...
## <a name="device-wlan"></a>Geräte-WLAN
...
Win32_MotherboardDevice-Klasse
...
## <a name="nap-system-health-agent"></a>NAP-Systemintegritäts-Agent

Namespace: root\Nap

NAP_SystemHealthAgent-Klasse
...
## <a name="network-adapter"></a>Netzwerkkarte
...
## <a name="network-adapter-configuration"></a>Netzwerkadapterkonfiguration
...
## <a name="network-client"></a>Netzwerkclient

Namespace: root\cimv2

Win32_NetworkClient-Klasse
...
## <a name="network-login-profile"></a>Profil für die Netzwerkanmeldung

Namespace: root\cimv2

Win32_NetworkLoginProfile-Klasse
...
## <a name="nt-eventlog-file"></a>NT-Ereignisprotokolldatei

Namespace: root\cimv2

Win32_NTEventlogFile-Klasse
...
Office365ProPlusConfigurations-Klasse
...
## <a name="office-addin"></a>Office-Add-In

Namespace: root\ccm\InvAgt

CCM_OfficeAddin-Klasse
...
## <a name="office-client-metric"></a>Office-Clientmetriken

Namespace: root\ccm\InvAgt

CCM_OfficeClientMetric-Klasse
...
## <a name="office-device-summary"></a>Office-Gerätezusammenfassung

Namespace: root\ccm\InvAgt

CCM_OfficeDeviceSummary-Klasse
...
## <a name="office-document-metric"></a>Office-Dokumentmetriken

Namespace: root\ccm\InvAgt

CCM_OfficeDocumentMetric-Klasse
...
## <a name="office-document-solution"></a>Office-Dokumentlösung

Namespace: root\ccm\InvAgt

CCM_OfficeDocumentSolution-Klasse
...
## <a name="office-macro-error"></a>Office-Makrofehler

Namespace: root\ccm\InvAgt

CCM_OfficeMacroError-Klasse
...
## <a name="office-product-info"></a>Office-Produktinformationen

Namespace: root\ccm\InvAgt

CCM_OfficeProductInfo-Klasse
...
## <a name="office-vba-rule-violation"></a>Office VBA-Regelverstöße

Namespace: root\ccm\InvAgt

CCM_OfficeVbaRuleViolation-Klasse
...
## <a name="office-vbasummary"></a>Office VBA-Zusammenfassung

Namespace: root\ccm\InvAgt

CCM_OfficeVbaScanResultsSummary-Klasse
...
## <a name="operating-system-ex"></a>Betriebssystem (Erweitert)

Namespace: root\cimv2

CCM_OperatingSystemExtended-Klasse
...
## <a name="operating-system-recovery-configuration"></a>Wiederherstellungskonfiguration des Betriebssystems

Namespace: root\cimv2

Win32_OSRecoveryConfiguration-Klasse
...
## <a name="optional-feature"></a>Optionale Features

Namespace: root\cimv2

Win32_OptionalFeature-Klasse
...
## <a name="page-file-setting"></a>Auslagerungsdateieinstellungen

Namespace: root\cimv2

Win32_PageFileSetting-Klasse
...
## <a name="parallel-port"></a>Paralleler Port

Namespace: root\cimv2

Win32_ParallelPort-Klasse
...
## <a name="physical-memory"></a>Physischer Speicher

Namespace: root\cimv2

Win32_PhysicalMemory-Klasse
...
## <a name="physicaldisk"></a>Physischer Datenträger
...
## <a name="pnp-device-driver"></a>PNP-Gerätetreiber
...
## <a name="pointing-device"></a>Zeigegerät

Namespace: root\cimv2

Win32_PointingDevice-Klasse
...
## <a name="portable-battery"></a>Tragbare Batterie

Namespace: root\cimv2

Win32_PortableBattery-Klasse
...
## <a name="power-capabilities"></a>Energiefunktionen

Namespace: root\CCM\powermanagementagent

CCM_PwrMgmtSystemPowerCapabilities-Klasse
...
## <a name="power-configurations"></a>Energiekonfiguration

Namespace: root\CCM\policy\machine\actualconfig

CCM_PowerConfig-Klasse
...
## <a name="power-management-insomnia-reasons"></a>Energieverwaltung: Ursachen von Störungen

Namespace: root\CCM\powermanagementagent

CCM_PwrMgmtLastSuspendError-Klasse
...
## <a name="power-management-daily"></a>Tägliche Energieverwaltung

Namespace: root\CCM\powermanagementagent

CCM_PwrMgmtActualDay-Löasse
...
## <a name="power-client-opt-out-settings"></a>Deaktivierungseinstellungen des Energieclients

Namespace: root\ccm\ClientSDK

CCM_PowerManagementClientOptoutSetting-Klasse
...
## <a name="power-management-monthly"></a>Monatliche Energieverwaltung

Namespace: root\CCM\powermanagementagent

CCM_PwrMgmtMonth-Klasse
...
## <a name="print-jobs"></a>Druckaufträge
...
## <a name="printer-configuration"></a>Druckerkonfiguration
...
## <a name="printer-device"></a>Druckergerät
...
## <a name="protected-volume-information"></a>Informationen zu geschützten Volumes

Namespace: root\cimv2\sms

CCM_ProtectedVolumeInfo-Klasse
...
Win32_QuickFixEngineering-Klasse
...
## <a name="ccm-recently-used-applications"></a>Zuletzt verwendete Anwendungen (CCM)

Namespace: root\cimv2\sms

CCM_RecentlyUsedApps-Klasse
...
## <a name="serial-port-configuration"></a>Serielle Portkonfiguration
...
## <a name="serial-ports"></a>Serielle Ports

Namespace: root\cimv2

Win32_SerialPort-Klasse
...
## <a name="sw-licensing-product"></a>SW-Lizenzierungsprodukt

Namespace: root\cimv2

SoftwareLicensingProduct-Klasse
...
## <a name="sw-licensing-service"></a>SW-Lizenzierungsdienst

Namespace: root\cimv2

SoftwareLicensingService-Klasse
...
## <a name="software-shortcut"></a>Softwareverknüpfung

Namespace: root\cimv2\sms

SMS_SoftwareShortcut-Klasse
...
## <a name="sound-devices"></a>Audiogeräte
...
## <a name="system-boot-data"></a>Systemstartdaten

Namespace: root\CCM

CCM_SystemBootData-Klasse
...
## <a name="system-boot-summary"></a>Systemstartzusammenfassung

Namespace: root\CCM

CCM_SystemBootSummary-Klasse
...
## <a name="system-console-usage"></a>Systemkonsolennutzung

Namespace: root\cimv2\sms

SMS_SystemConsoleUsage-Klasse
...
## <a name="system-console-user"></a>Systemkonsolenbenutzer

Namespace: root\cimv2\sms

SMS_SystemConsoleUser-Klasse
...
## <a name="system-devices"></a>Systemgeräte

Namespace: root\cimv2\sms

CCM_SystemDevices-Klasse
...
## <a name="system-drivers"></a>Systemtreiber
...
## <a name="system-enclosure"></a>Systemgehäuse

Namespace: root\cimv2

Win32_SystemEnclosure-Klasse
...
## <a name="ts-issued-license"></a>Für Terminaldienste ausgestellte Lizenzen

Namespace: root\cimv2

Win32_TSIssuedLicense-Klasse
...
## <a name="ts-license-key-pack"></a>Lizenzschlüsselpaket für Terminaldienste

Namespace: root\cimv2

Win32_TSLicenseKeyPack-Klasse
...
## <a name="uninterruptible-power-supply"></a>Unterbrechungsfreie Stromversorgung

Namespace: root\cimv2

Win32_UninterruptiblePowerSupply-Klasse
...
## <a name="usb-device"></a>USB-Gerät

Namespace: root\cimv2

Win32_USBDevice-Klasse
...
## <a name="usm-user-profile"></a>USM-Benutzerprofil
...
## <a name="video-controller"></a>Videocontroller
...
## <a name="virtual-application-packages"></a>Virtuelle Anwendungspakete
...
## <a name="virtual-machine-64"></a>Virtuelle Computer (64-Bit)

Namespace: root\cimv2

Win32Reg_SMSGuestVirtualMachine64-Klasse
...
Win32Reg_SMSGuestVirtualMachine-Klasse
...
## <a name="virtual-machine-details"></a>Details zu virtuellen Computern
...
SMS_Windows8Application-Klasse
...
SMS_Windows8ApplicationUserInfo-Klasse
...
Win32Reg_SMSWindowsUpdate-Klasse
...
## <a name="windows-update-agent-version"></a>Version des Windows Update-Agents

Namespace: root\cimv2\sms

Win32_WindowsUpdateAgentVersion-Klasse
...
## <a name="write-filter-state"></a>Schreibfilterzustand

Namespace: root\cimv2\sms

CCM_WriteFilterState-Klasse
