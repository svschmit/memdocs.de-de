...
description: Windows Analytics umfasst eine Reihe von Lösungen, mit denen Sie wertvolle Einblicke in den aktuellen Status Ihrer Umgebung gewinnen.
ms.date: 01/31/2020
...
Wenn Ihr Configuration Manager-Standort mit der Upgradebereitschaft verbunden war, müssen Sie ihn entfernen und Clients neu konfigurieren. Weitere Informationen finden Sie unter [Entfernen der Upgradebereitschaftsverbindung](upgrade-readiness.md#bkmk_remove).
