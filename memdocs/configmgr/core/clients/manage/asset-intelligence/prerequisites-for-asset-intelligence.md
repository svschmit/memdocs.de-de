...
|Reporting Services-Punkt|Die Standortsystemrolle des Reporting Services-Punkts muss installiert werden, damit Berichte zu Softwareupdates angezeigt werden können. Weitere Informationen über die Erstellung eines Reporting Services-Punkts finden Sie unter [Configuring Reporting in Configuration Manager (Konfigurieren der Berichterstattung in Configuration Manager)](https://go.microsoft.com/fwlink/p/?LinkId=232661).|  
