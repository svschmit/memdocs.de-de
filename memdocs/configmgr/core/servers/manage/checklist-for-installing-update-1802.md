---
title: Checkliste für Version 1802
titleSuffix: Configuration Manager
description: In diesem Artikel erhalten Sie Informationen zu Vorbereitungen, die Sie treffen müssen, bevor Sie ein Update auf Version 1802 von Configuration Manager durchführen.
ms.date: 06/08/2018
...
ms.locfileid: "81707678"
---
# <a name="checklist-for-installing-update-1802-for-configuration-manager"></a>Checkliste für die Installation von Update 1802 für Configuration Manager

*Gilt für: Configuration Manager (Current Branch)*

Wenn Sie den Current Branch von Configuration Manager verwenden, können Sie das konsoleninterne Update für Version 1802 installieren, um die Hierarchie einer älteren Version zu aktualisieren. <!-- baseline only statement: -->(Da Version 1802 auch als [Baselinemedium](updates.md#bkmk_Baselines) zur Verfügung steht, können Sie das Installationsmedium zum Installieren des ersten Standorts der neuen Hierarchie verwenden.)

Für das Update auf Version 1802 müssen Sie einen Dienstverbindungspunkt auf der obersten Ebene Ihrer Hierarchie verwenden. Die Standortsystemrolle kann im Online- oder Offlinemodus erfolgen. Nachdem Ihre Hierarchie das Updatepaket von Microsoft heruntergeladen hat, befindet es sich in der Konsole im Arbeitsbereich **Verwaltung**  im Knoten **Updates und Wartung**.
...
**Stellen Sie sicher, dass an allen Standorten eine Version von Configuration Manager ausgeführt wird, die ein Update auf Version 1802 unterstützt:**    
Auf jedem Standortserver in der Hierarchie muss die gleiche Version von Configuration Manager ausgeführt werden, bevor Sie die Installation des Updates 1802 starten können. Sie können die Versionen 1702, 1706 und 1710 auf 1802 aktualisieren.
...
<!--SCCMdocs#587-->   
Wenn Sie Configuration Manager mit anderen Produkten von Microsoft oder Microsoft-Partnern erweitern, vergewissern Sie sich, dass diese Produkte Version 1802 unterstützen. Wenden Sie sich für diese Informationen an den Hersteller des Produkts. Lesen Sie beispielsweise die [Anmerkungen zu dieser Version von Microsoft Deployment Toolkit](../../../mdt/release-notes.md).
...
Wechseln Sie zum Arbeitsbereich **Verwaltung**, und klicken Sie auf **Updates und Wartung**, um eine Voraussetzungsprüfung durchzuführen. Wählen Sie das Updatepaket **Configuration Manager 1802** aus, und klicken Sie im Menüband auf **Voraussetzungsprüfung ausführen**.
...
6. Wenn Sie Erweiterungen für Configuration Manager verwenden, aktualisieren Sie diese auf die neueste Version, damit dieses Update von Configuration Manager unterstützt wird. 
