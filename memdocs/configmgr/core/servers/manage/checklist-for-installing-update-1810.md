---
title: Checkliste für Version 1810
titleSuffix: Configuration Manager
description: In diesem Artikel erhalten Sie Informationen zu Vorbereitungen, die Sie treffen müssen, bevor Sie ein Update auf Version 1810 von Configuration Manager durchführen.
ms.date: 02/28/2019
...
ms.locfileid: "88126187"
---
# <a name="checklist-for-installing-update-1810-for-configuration-manager"></a>Checkliste für die Installation von Update 1810 für Configuration Manager

*Gilt für: Configuration Manager (Current Branch)*

Wenn Sie Configuration Manager Current Branch verwenden, können Sie das konsoleninterne Update für Version 1810 installieren, um die Hierarchie einer älteren Version zu aktualisieren. <!-- baseline only statement: (Because version 1802 is also available as [baseline media](updates.md#a-namebkmkbaselinesa-baseline-and-update-versions), you can use the installation media to install the first site of a new hierarchy.)-->

Für das Update auf Version 1810 müssen Sie einen Dienstverbindungspunkt auf der obersten Ebene Ihrer Hierarchie verwenden. Die Standortsystemrolle kann im Online- oder Offlinemodus erfolgen. Nachdem in Ihrer Hierarchie das Updatepaket von Microsoft heruntergeladen wurde, ist dieses in der Konsole enthalten. Wählen Sie im Arbeitsbereich **Verwaltung** den Knoten **Updates und Wartung** aus.

-   Wenn das Update als **Verfügbar** aufgeführt ist, ist das Update zur Installation bereit. Sehen Sie sich vor der Installation von Version 1810 die folgenden Informationen [zur Installation von Update 1810](#about-installing-update-1810) und die [Checkliste](#checklist) für Konfigurationen an, die vor dem Starten des Updates durchgeführt werden müssen.
...
## <a name="about-installing-update-1810"></a>Informationen zur Installation des Updates 1810
...
Auf jedem Standortserver in der Hierarchie muss die gleiche Version von Configuration Manager ausgeführt werden, bevor Sie die Installation des Updates 1810 starten können. Sie können die Version 1710, 1802 oder 1806 auf 1810 aktualisieren.
...
Die Version des Windows 10 ADK (Windows 10 Assessment and Deployment Kit) sollte für Configuration Manager-Version 1810 unterstützt werden. Weitere Informationen zu unterstützten Windows ADK-Versionen finden Sie unter [Windows 10 ADK](../../plan-design/configs/support-for-windows-10.md#windows-10-adk). Wenn Sie das Windows ADK aktualisieren müssen, sollten Sie dies vor dem Update von Configuration Manager durchführen. Durch diese Reihenfolge wird sichergestellt, dass die Standardstartimages automatisch auf die neueste Version der Windows PE aktualisiert werden. Benutzerdefinierte Startimages müssen nach der Aktualisierung des Standorts manuell aktualisiert werden.
...
Bevor Sie einen Standort aktualisieren, müssen Sie die Antivirensoftware auf den Configuration Manager-Servern beenden. <!--SMS.503481--> 
...
Wechseln Sie zum Arbeitsbereich **Verwaltung**, und klicken Sie auf **Updates und Wartung**, um eine Voraussetzungsprüfung durchzuführen. Wählen Sie das Updatepaket **Configuration Manager 1810** aus, und klicken Sie im Menüband auf **Voraussetzungsprüfung ausführen**.
...
Stellen Sie sicher, dass jeder Standortserver und jede Standortsystemrolle auf Version 1810 aktualisiert wurde. Fügen Sie in der Konsole im Arbeitsbereich **Verwaltung** die Spalte **Version** zu den Knoten **Standorte** und **Verteilungspunkte** hinzu. Wenn dies nötig ist, wird automatisch erneut eine Standortsystemrolle installiert, um diese auf die neueste Version zu aktualisieren. 
...
Wenn Sie Erweiterungen für Configuration Manager verwenden, aktualisieren Sie diese auf die neueste Version, damit Version 1810 von Configuration Manager unterstützt wird. 
