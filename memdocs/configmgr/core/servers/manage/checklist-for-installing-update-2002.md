...
Wenn Sie den Current Branch von Configuration Manager verwenden, können Sie das konsoleninterne Update für Version 2002 installieren, um die Hierarchie einer älteren Version zu aktualisieren. <!-- baseline only statement:-->Version 2002 steht auch als [Baselinemedium](updates.md#bkmk_Baselines) zur Verfügung, daher können Sie das Installationsmedium zum Installieren des ersten Standorts einer neuen Hierarchie verwenden.
