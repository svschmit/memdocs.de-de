---
title: Diagnose- und Nutzungsdaten für Version 1906
titleSuffix: Configuration Manager
description: Hier erfahren Sie mehr über die spezifischen Daten, die Configuration Manager in Version 1906 auf den einzelnen Ebenen sammelt.
ms.date: 07/26/2019
...
Bei Version 1906 von Configuration Manager umfasst diese Ebene folgende Daten:

- ***[Aktualisiert]*** Statistik zu den Configuration Manager-Konsolenverbindungen: Betriebssystemversion, Sprache, SKU und Architektur, Systemspeicher, Anzahl der logischen Prozessoren, Verbindungsstandort-ID, installierte .NET-Versionen, Sprachpakete für die Konsole und unterstützte Authentifizierungsebene
...
- ***[Neu]*** Status und Integrität des Verwaltungsdiensts

- ***[Neu]*** Hash der wichtigsten Standortattribute (Standort-ID, SQL-Broker-ID und Austauschschlüssel des Standorts)
...
- ***[Neu]*** Anzahl der Sammlungen, die mit Azure Active Directory synchronisiert wurden
...
- ***[Neu]*** Anzahl doppelter Hardware-IDs (MAC-Adresse und SMBIOS GUID), die von PXE und Clientregistrierung ausgeschlossen sind

- ***[Neu]*** Anzahl der Tasksequenzen nach Typ (Betriebssystembereitstellung oder generische Tasksequenz)

- ***[Neu]*** Anzahl der Pakete mit Inhaltseinstellungen mit vorgeschaltetem Cache
...
- ***[Neu]*** Liste der Abonnements von Katalogen mit Updates für Drittanbietersoftware

- ***[Neu]*** Verwendung von WSUS-Wartungseinstellungen
...
- ***[Neu]*** Aggregierte Leistungsstatistiken zu Aufrufen von Softwarecenter-Endpunkten am Verwaltungspunkt
...
- ***[Neu]*** Aggregierte Statistiken zur Nutzung von Desktop Analytics

- ***[Neu]*** Konfiguration und Status von SQL-Wartungstasks
...
- ***[Neu]*** Liste der Configuration Manager-Konsolenerweiterungen
