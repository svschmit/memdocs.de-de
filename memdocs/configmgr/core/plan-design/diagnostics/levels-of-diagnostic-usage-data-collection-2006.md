---
title: Diagnose- und Nutzungsdaten für Version 2006
titleSuffix: Configuration Manager
description: Erfahren Sie mehr zu den spezifischen Daten, die Configuration Manager in Version 2006 auf den einzelnen Ebenen sammelt.
ms.date: 08/11/2020
...
ms.locfileid: "88129588"
---
# <a name="diagnostic-and-usage-data-for-version-2006"></a>Diagnose- und Nutzungsdaten für Version 2006
...
Bei Version 2006 von Configuration Manager umfasst diese Ebene folgende Daten:
...
- Grundlegende Daten zur Configuration Manager-Standorthierarchie: Standortliste, Typ, Version, Status, Anzahl von Clients, Zeitzone und Integritätsstatus
...
- Integritätsinformationen zum Standort

- Speicherort für Absturzinformationen zur Configuration Manager-Konsole

- Nutzungsstatistiken zur Configuration Manager-Konsole

- Aktionen zum Herstellen und Trennen der Verbindung mit der Cloud

- Status der letzten Synchronisierung mit dem Intune-Clouddienst

- Anzahl der Fehler des Verwaltungsdiensts

- Verwendung des Massenregistrierungstokens

- Anzahl der Clients, nach Standard- und bevorzugtem Browser

- ***[Verschoben]*** Statistiken zur Konfiguration und Nutzung von Cloud Management Gateway: Anzahl der Regionen und Umgebungen und Statistiken zur Authentifizierung/Autorisierung  

- ***[Verschoben]***  Informationen zu SQL Always On-Replikat, Nutzung und Integrationsstatus  

- ***[Neu]*** Konfiguration und Status von Benachrichtigungen in der Verwaltungskonsole

- ***[Neu]*** Konfiguration und Status der Überwachung der Standortintegrität
...
- Aggregierte Statistiken zu Office-Add-Ins, Nutzung des Office Readiness Toolkit und Anzahl der Clients mit Microsoft 365-Apps

- Aggregierte Statistik zur Integrität von Office-Add-Ins

- Anzahl und Größe von Office Pro Plus-Pilotsammlungen

- Anzahl von Office Pro Plus-Geräten, die Office-Integritätsdaten senden
...
- ***[Aktualisiert]*** - ***[Neu]*** Anzahl von Softwareinventurregeln, Dateisammlungsregeln und allgemeiner Integritätsstatus
...
- ***[Neu]*** Zusammengefasste Anzahl von Endpunktanalyseereignissen
...
- Verwendung des Assistenten zum Integrieren von Clouddiensten
...
- ***[Neu]*** Anzahl von Konformitätseinstellungen, die nach Kategorie, Betriebssystem und Quelle bereitgestellt werden (Cloud oder lokal)
...
- Konsolenleistungsdaten

- Die 25 häufigsten Aktionen, Assistenten, Eigenschaftenblätter und Strukturknoten, auf die in der Konsole zugegriffen wird
...
- Anzahl der Subnetze, die aus dem Peercache ausgeschlossen wurden
...
- Aggregierte Statistiken für Microsoft Defender Advanced Threat Protection-Richtlinien
...
- Anzahl bereitgestellter Updates für Microsoft 365-Apps  
...
- Verwendung von Orchestrierungsgruppen

- Fallbackkonfigurationseinstellungen für Windows Update
...
- Status aktueller Neuinitialisierungsanforderungen
...
- Anzahl von Clients mit Browserverwendung
