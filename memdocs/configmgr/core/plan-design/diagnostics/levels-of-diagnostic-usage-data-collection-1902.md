---
title: Diagnose- und Nutzungsdaten für Version 1902
titleSuffix: Configuration Manager
description: Hier erfahren Sie mehr über die spezifischen Daten, die Configuration Manager in Version 1902 auf den einzelnen Ebenen sammelt.
ms.date: 05/13/2019
...
Bei Version 1902 von Configuration Manager umfasst diese Ebene folgende Daten:
...
- ***[Neu]*** Vorhandensein von serverseitigen Erweiterungen für Microsoft BitLocker Administration and Monitoring (MBAM)  

- ***[Neu]*** Anzahl von kategorisierten und nicht kategorisierten Anwendungen für Asset Intelligence
...
- ***[Neu]*** Anzahl von Geräten nach Office ProPlus-Bereitschaftszustand
...
- ***[Aktualisiert]*** Clientintegritätsstatistiken und Zusammenfassung wichtiger Probleme nach Clientversion, Komponente, Betriebssystem und Workload  
...
- ***[Neu]*** Anzahl von Fehlern bei der Clientintegritätsprüfung nach Problemtyp
...
- ***[Neu]*** Anzahl der OneDrive-Richtlinien (erstellt, bereitgestellt)
...
- ***[Aktualisiert]*** Konfiguration des Data Warehouse-Dienstpunkts, einschließlich Synchronisierungszeitplan, durchschnittlicher Dauer und Verwendung des Features für benutzerdefinierte Tabellen  

- ***[Aktualisiert]*** Anzahl von Skripts und Statistiken zu deren Ausführung/Bearbeitung  
...
- ***[Neu]*** Aggregierte Statistik zu Desktop Analytics-Registrierungsfehlern und zur Nutzung

- ***[Neu]*** Anzahl von nicht kritischen Konsolenbenachrichtigungen

- ***[Neu]*** Aggregierte Zeitstatistik zum Systemstart nach Betriebssystem, Formfaktor und Laufwerktyp
