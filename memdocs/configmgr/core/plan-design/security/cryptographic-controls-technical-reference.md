...
Weitere Informationen finden Sie unter [Beschränken der Verwendung bestimmter kryptografischer Algorithmen und Protokolle in „Schannel.dll“](https://support.microsoft.com/help/245030/) und [Prioritizing Schannel Cipher Suites (Priorisieren von Schannel-Cipher-Suites)](/windows/win32/secauthn/prioritizing-schannel-cipher-suites). Diese Verfahren haben keine Auswirkungen auf die Configuration Manager-Funktionalität.