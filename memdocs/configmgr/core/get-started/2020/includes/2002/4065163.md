...
ms.locfileid: "88703613"
---
## <a name="office-365-updates-for-disconnected-software-update-points"></a><a name="bkmk_O365"></a> Office 365-Updates für nicht verbundene Softwareupdatepunkte
<!--4065163-->
...
1. Wenn die Synchronisierung abgeschlossen ist, lehnen Sie alle Office 365-Updates ab, die Sie nicht mit Configuration Manager bereitstellen möchten. Sie müssen Office 365-Updates nicht genehmigen, damit diese heruntergeladen werden.  
   ...
   - Das OfflineUpdateExporter-Tool führt den Download von Office 365-Updates für Sie aus. Für andere Produkte muss der Download weiterhin genehmigt werden, wenn Sie Updates für diese Produkte exportieren.
    - Erstellen Sie eine [neue Updateansicht in WSUS](/windows-server/administration/windows-server-update-services/manage/viewing-and-managing-updates#to-create-a-new-update-view-on-wsus), um nicht benötigte Office 365-Updates in WSUS einfach anzeigen und ablehnen zu können.
...
- Derzeit werden die Inhalte für alle Office 365-Sprachen heruntergeladen. Jedes Update kann ca. 10 GB an Inhalten enthalten.
