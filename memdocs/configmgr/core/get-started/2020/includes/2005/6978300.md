...
Weitere Informationen zur Verwendung von PowerShell mit Configuration Manager finden Sie unter [Erste Schritte mit Configuration Manager-Cmdlets](/powershell/sccm/overview?view=sccm-ps).
