...
Mithilfe dieses Dashboards können Sie Computer überprüfen, die in Ihrer Umgebung gemeinsam verwaltet werden. Mithilfe der Diagramme können Geräte identifiziert werden, bei denen möglicherweise ein Eingriff erforderlich ist.<!--1356648,1358980-->
...
### <a name="co-management-status"></a>Co-Verwaltungsstatus
...
| 2149056533 (0x80180015)<br>MENROLL_E_NOTSUPPORTED | Verwaltung mobiler Geräte wird nicht unterstützt. Überprüfen Sie Geräteeinschränkungen. |
...
Ein Gerät wird gemeinsam verwaltet, wenn die Felder **MDMEnrolled** und **ComgmtPolicyPresent** den Wert `1` haben.