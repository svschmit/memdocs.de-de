...
Um beste Ergebnisse zu erzielen, müssen Sie möglicherweise den [Downloadmodus](https://docs.microsoft.com/windows/deployment/update/waas-delivery-optimization-reference#download-mode) der Übermittlungsoptimierung auf **Gruppe (2)** festlegen und *Gruppen-IDs* definieren. Im Gruppenmodus kann das Peering interne Subnetze zwischen Geräten überschreiten, die zur selben Gruppe gehören, Geräte in Remotebüros inbegriffen. Verwenden Sie die [Gruppen-ID-Option](https://docs.microsoft.com/windows/deployment/update/waas-delivery-optimization-reference#select-the-source-of-group-ids), um Ihre eigene benutzerdefinierte Gruppe unabhängig von Domänen und AD DS-Standorten zu erstellen. Der Downloadmodus „Gruppe“ wird den meisten Organisationen empfohlen, die die beste Bandbreitenoptimierung mit Übermittlungsoptimierung anstreben.
...
Weitere Informationen zu Netzwerkports, Proxyanforderungen und Hostnamen für Firewalls finden Sie unter [Häufig gestellte Fragen](https://docs.microsoft.com/windows/deployment/update/waas-delivery-optimization#frequently-asked-questions).
