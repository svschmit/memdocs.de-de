...
Ab Version 2002 können Sie das folgenden PowerShell-Cmdlet von Windows für diese Aufgabe verwenden: [Move-CMPhasedDeploymentToNext](/powershell/module/configurationmanager/move-cmphaseddeploymenttonext).
