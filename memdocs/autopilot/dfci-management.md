...
- Das Gerät muss mit Microsoft InTune verwaltet werden. Weitere Informationen finden Sie unter [Registrieren von Windows-Geräten in InTune mithilfe von Windows Autopilot](https://docs.microsoft.com/intune/enrollment/enrollment-autopilot).
...
Weitere Informationen finden Sie unter [Erstellen der Profile](https://docs.microsoft.com/intune/configuration/device-firmware-configuration-interface-windows#create-the-profiles) und [Zuweisen der Profile und Neustarten](https://docs.microsoft.com/intune/configuration/device-firmware-configuration-interface-windows#assign-the-profiles-and-reboot) .

Sie können auch [vorhandene dfci-Einstellungen](https://docs.microsoft.com/intune/configuration/device-firmware-configuration-interface-windows#update-existing-dfci-settings) auf Geräten ändern, die verwendet werden. Ändern Sie in Ihrem vorhandenen dfci-Profil die Einstellungen, und speichern Sie die Änderungen. Da das Profil bereits zugewiesen ist, werden die neuen dfci-Einstellungen wirksam, wenn das Gerät das nächste Mal neu gestartet wird oder das Gerät neu gestartet wird.
...
[Windows Autopilot-und Surface-Geräte](https://docs.microsoft.com/surface/windows-autopilot-and-surface-devices)<br>